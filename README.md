...
| `product-planning` | 产品立项企划 | `/product-planning "{产品企划}" {SITE}` | 市场、竞品、SWOT、成本和销售计划闭环企划 |
...
- **企划闭环**：意向产品 → 市场分析 → 竞品优化 → SWOT → ABA/关键词 → 成本试算 → 销售计划。
- **证据驱动**：企划结论必须来自 SellerSprite MCP、已有研究报告、成本假设或明确标注的人工假设。
- **财务可行性**：按采购价、平台售价、佣金、FBA/履约、头程、退款率、广告占比计算毛利率和毛利润。
- **上架计划**：输出前三个月销量、销售额、毛利、价格阶段、生命周期阶段和 P0/P1/P2 动作。
...
```text
意向产品 → 市场分析 → 竞品分析与优化策略 → SWOT → ABA/关键词 → 成本试算 → 销售计划 → 进入/观察/放弃决策
```

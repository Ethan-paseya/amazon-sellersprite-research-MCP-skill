...
- **默认美化模板**：优先使用 `templates/product_planning_standard_template_V1_beautified.xlsx`；功能一至四为已验证卖点，功能五至七为未满足需求。旧 V1 工作簿仅作为兼容备份。
...
当前版本以 Python 工具链为默认执行入口，保留 SellerSprite MCP 六类研究技能、`product-planning` V1 美化会议版模板、脱敏检查和 Gemini/GLM 交叉验证规范。
